...
|:--------------|:-------------|:-------------|:-------------|
| 0.22.2 | 10.5.22 | application | [Git repo](https://github.com/sapcc/helm-charts/tree/mariadb-galera/common/mariadb-galera) |
...
* [push](https://helm.sh/docs/topics/registries/#the-push-subcommand) the chart to the registry
  ```shell
  helm push mariadb-galera-0.22.2.tgz oci://keppel.eu-de-1.cloud.sap/ccloud-helm/
  ```
