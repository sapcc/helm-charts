...
SET @createuser := CONCAT("CREATE OR REPLACE USER ", QUOTE(@user), "@", QUOTE(@host), " IDENTIFIED VIA ", @authplugin, " USING PASSWORD(", QUOTE(@pass), ") WITH MAX_USER_CONNECTIONS ", @connlimit);
