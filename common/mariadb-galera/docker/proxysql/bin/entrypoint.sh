...
REQUIRED_ENV_VARS=("PROXYSQL_ADMIN_USERNAME" "PROXYSQL_ADMIN_PASSWORD" "PROXYSQL_MONITOR_USERNAME" "PROXYSQL_MONITOR_PASSWORD" "PROXYSQL_STATS_USERNAME" "PROXYSQL_STATS_PASSWORD")
MAX_RETRIES=10
WAIT_SECONDS=6
