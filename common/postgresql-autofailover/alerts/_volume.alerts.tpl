...
- name: volume.alerts
  ...
  - alert: {{ include "alerts.name_prefix" . }}PostgresVolumeNearlyFull
    {{- $pvc := .Values.persistence.existingClaim | default (include "postgresql-auto-failover.fullname" .) }}
    ...
    annotations:
      description: |
        The PhysicalVolume for the {{ template "postgresql-auto-failover.fullname" . }} database is more than 95% full. Try running a full vacuum
      ...
      summary: {{ template "postgresql-auto-failover.fullname" . }} DB volume is almost full
