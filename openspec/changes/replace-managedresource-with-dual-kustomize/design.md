...
| 4 | Deployment name mismatch: kustomize `controller-manager` vs helm `metal-operator-controller-manager`. | **fix in this repo** (Section 19 — rename Deployment to match helm; verified 2026-06-10 against rt-eu-de-1's helm-deployed `metal-operator-controller-manager-9d4b46c95` Pod) |
