...
Defines the build-time transformation that converts upstream service-based webhook configurations into URL-based clientConfig for the workerless virtual cluster, producing a static file that kustomize consumes at deploy time.
