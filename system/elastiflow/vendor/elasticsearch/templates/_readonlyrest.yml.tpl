...
readonlyrest:
    ...
    access_control_rules:
      ...
      - name: data
        ...
        indices: ["elastiflow-*"]
        auth_key: {{.Values.global.elastiflow_user}}:{{.Values.global.elastiflow_password}}

      # admin user
      - name: Admin
        auth_key: {{.Values.global.elastiflow_admin_user}}:{{.Values.global.elastiflow_admin_password}}
