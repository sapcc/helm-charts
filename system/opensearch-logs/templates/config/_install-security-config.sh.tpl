...
$OPENSEARCH_BASE/plugins/opensearch-security/tools/securityadmin.sh -icl -key $OPENSEARCH_BASE/config/certs/admin/tls.key -cert  $OPENSEARCH_BASE/config/certs/admin/tls.crt -cacert /etc/ssl/certs/ca-certificates.crt -cd $OPENSEARCH_BASE/config/security/ -h opensearch-logs-client.{{ .Values.global.clusterType}}.{{ .Values.global.region }}.{{ .Values.global.tld }}
