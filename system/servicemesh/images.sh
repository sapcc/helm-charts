...
docker build --network=host -t keppel.eu-de-1.cloud.sap/ccloud/linkerd/extension-init:$LINKERD_EXTENSION_INIT_VERSION --build-arg IMAGE="cr.l5d.io/linkerd/extension-init:$LINKERD_EXTENSION_INIT_VERSION" - < Dockerfile
