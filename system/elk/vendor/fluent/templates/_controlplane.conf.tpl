...
(qa-de-1)d042653@PDHXDQFMJW:~/github.com/sapcc/helm-charts/system/elk/vendor/fluent/templates$ ls
_fluent-start.tpl		_logstash.json.tpl		_prometheus.conf.tpl		_qade3-logstash.json.tpl	alerts				configmap.yaml			metrics-podmonitor.yaml		rolebindings.yaml
_fluent.conf.tpl		_pattern.tpl			_qade2-logstash.json.tpl	_qade5-logstash.json.tpl	clusterrole.yaml		daemonset.yaml			prometheus-alerts.yaml		serviceaccount.yaml
(qa-de-1)d042653@PDHXDQFMJW:~/github.com/sapcc/helm-charts/system/elk/vendor/fluent/templates$ vi _scaleout.conf.tpl
(qa-de-1)d042653@PDHXDQFMJW:~/github.com/sapcc/helm-charts/system/elk/vendor/fluent/templates$ cat _fluent.conf.tpl
