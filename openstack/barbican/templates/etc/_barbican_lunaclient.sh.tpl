...
lunaclient()
    ...
    # echo "client assignPartition -c $HOSTNAME-$NOW -p {{ .Values.lunaclient.conn.par | include "resolve_secret"  }}" > /thales/safenet/lunaclient/config/$HOSTNAME-$NOW-multi.txt
