...
function cleanup_tempest_leftovers() {
  ...
  openstack user set tempestuser1 --domain tempest --password={{ .Values.tempestAdminPassword | include "tempest-base.resolve_secret" }}
  openstack user set tempestuser2 --domain tempest --password={{ .Values.tempestAdminPassword | include "tempest-base.resolve_secret" }}
}
