{
    ...
    "viewer": "(role:load-balancer_observer or role:network_viewer)  and rule:owner",
    "admin": "(role:load-balancer_admin or role:network_admin) and rule:owner",
    "memberadmin": "role:load-balancer_member and rule:owner",
    "context_is_load-balancer_admin": "rule:context_is_admin or rule:admin",
    "context_is_editor": "rule:context_is_load-balancer_admin or rule:member",
    ...
    "os_load-balancer_api:flavor:post": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor:put": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor:get_one": "rule:context_is_viewer",
    "os_load-balancer_api:flavor:delete": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor-profile:get_all": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor-profile:post": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor-profile:put": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor-profile:get_one": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:flavor-profile:delete": "rule:context_is_load-balancer_admin",
    ...
    "os_load-balancer_api:loadbalancer:put_failover": "rule:context_is_load-balancer_admin",
    ...
    "os_load-balancer_api:amphora:get_one": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:amphora:put_config": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:amphora:put_failover": "rule:context_is_load-balancer_admin",
    "os_load-balancer_api:amphora:get_stats": "rule:context_is_load-balancer_admin",

    "os_load-balancer_api:provider-flavor:get_all": "rule:context_is_load-balancer_admin"
}
