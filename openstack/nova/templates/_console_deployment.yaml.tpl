...
spec:
  ...
  {{- $strategy := dig "console" "podReplacementStrategy" .Values.pod.lifecycle.upgrades.deployments.podReplacementStrategy .Values.pod.lifecycle.upgrades.deployments.overrides }}
  strategy:
    type: {{ $strategy }}
