...
{{ tuple . "nova" "compute" | include "helm-toolkit.snippets.kubernetes_metadata_labels" | indent 8 }}
    ...
    spec:
      ...
      containers:
        - name: nova-compute
          image: {{ required ".Values.global.image_registry is missing" .Values.global.image_registry}}/ubuntu-source-nova-compute:{{.Values.imageVersionNovaCompute | default .Values.imageVersionNova | default .Values.imageVersion | required "Please set nova.imageVersion or similar" }}
