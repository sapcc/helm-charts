...
{{- else -}}
mysql+pymysql://{{.Values.cell0dbUser}}:{{.Values.cell0dbPassword | urlquery }}@${{.Chart.Name}}-mariadb.{{include "svc_fqdn" .}}:3306/{{.Values.cell0dbName}}?charset=utf8
{{- end -}}
{{- end -}}
...
{{- else -}}
mysql+pymysql://{{.Values.cell2dbUser}}:{{.Values.cell2dbPassword | urlquery }}@${{.Chart.Name}}-cell2-mariadb.{{include "svc_fqdn" .}}:3306/{{.Values.cell2dbName}}?charset=utf8
{{- end -}}
{{- end -}}
{{- end -}}
