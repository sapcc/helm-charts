...
{{- define "container_image_nova" -}}
  ...
  {{- with index . 0 -}}
    ...
    {{ required ".Values.global.image_registry is missing" .Values.global.image_registry}}/{{$image_name}}:{{index .Values $version_name | default .Values.imageVersionNova | default .Values.imageVersion | required "Please set nova.imageVersionNova or similar" }}
...
{{- define "container_image_openvswitch" -}}
  ...
  {{- with index . 0 -}}
    ...
    {{ required ".Values.global.image_registry is missing" .Values.global.image_registry}}/{{$image_name}}:{{index .Values $version_name | default .Values.imageVersionOpenvswitch | default .Values.imageVersionNova | default .Values.imageVersion | required "Please set imageVersionOpenvswitch or similar" }}
...
{{- define "container_image_neutron" -}}
  ...
  {{- with index . 0 -}}
    ...
    {{ required ".Values.global.image_registry is missing" .Values.global.image_registry}}/{{$image_name}}:{{index .Values $version_name | default .Values.imageVersionNeutron | required "Please set imageVersionNeutron or similar" }}
