...
keystone = cors http_proxy_to_wsgi compute_req_id faultwrap request_log sizelimit {{- include "osprofiler_pipe" . }} authtoken keystonecontext {{- include "watcher_pipe" . }} {{ if .Values.rate_limit.enabled }}{{- include "rate_limit_pipe" . }}{{ end }} sentry {{- include "audit_pipe" . }} osapi_compute_app_v21
