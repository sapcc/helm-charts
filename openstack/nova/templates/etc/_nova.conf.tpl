...
password = {{ required ".Values.global.nova_service_password is missing" .Values.global.nova_service_password | replace "$" "$$" }}
...
password = {{ required ".Values.global.placement_service_user is missing" .Values.global.placement_service_user | replace "$" "$$" }}
user_domain_name = "{{.Values.global.keystone_service_domain | default "Default" }}"
