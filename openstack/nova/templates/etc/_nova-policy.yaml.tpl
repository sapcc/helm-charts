...
os_compute_api:servers:migrations:index: rule:context_is_admin or rule:context_is_cloud_viewer

# Show details for an in-progress live migration for a given server
#   GET /servers/{server_id}/migrations/{migration_id}
#os_compute_api:servers:migrations:show: rule:system_reader_api
os_compute_api:servers:migrations:show: rule:context_is_admin or rule:context_is_cloud_viewer
