...
- name: IDENTITY_ENDPOINT
  value: {{ .Values.identity_endpoint | default (printf "http://keystone.%s.svc.kubernetes.%s.%s:5000/v3" (default .Release.Namespace .Values.global.keystoneNamespace) .Values.global.region .Values.global.tld) | quote }}
- name: CEPH_REGION
