...
broker.id=MONASCA_KAFKA_ENDPOINT_ID
...
#advertised.host.name=MONASCA_KAFKA_ENDPOINT_HOST_INTERNAL
...
log.dirs=/var/opt/kafka/datalogs
...
zookeeper.connect=zk:{{.Values.monasca_zookeeper_port_internal}}
