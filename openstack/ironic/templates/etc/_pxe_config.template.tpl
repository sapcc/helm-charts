...
{{- $conductor := index . 1 }}
{{- with index . 0 }}
{{- $prefix := or (and (eq "lpxelinux.0" ($conductor.pxe_bootfile_name | default .Values.conductor.pxe_bootfile_name | default "pxelinux.0")) (printf "http://%v:%v/" .Values.global.ironictftpIP .Values.conductor.deploy.port)) "" }}
default deploy
