...
/usr/local/bin/openstack-seeder --logtostderr --v {{ default 1 .Values.logLevel }} {{- if .Values.dryRun }} --dry-run{{- end }} {{- if .Values.ignoreNamespace }} --ignorenamespace={{- .Values.ignoreNamespace }}{{- end }} {{- if .Values.onlyNamespace }} --onlynamespace={{- .Values.onlyNamespace }}{{- end }}
