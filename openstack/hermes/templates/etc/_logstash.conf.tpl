...
output {
  ...
  if [type] == 'audit' {
    if ([initiator][domain] == 'ccadmin' or [target][project_domain_name] == 'ccadmin' or [initiator][project_domain_name] == 'ccadmin') or ([observer][typeURI] == "service/security" and [action] == "authenticate" and [outcome] == "failure") {
      http {
