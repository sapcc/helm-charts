...
# Store the session in the client cookie (encrypted with the shared crypto
# passphrase) instead of the default per-pod server cache, so the post-callback
# request can be served by any keystone replica.
