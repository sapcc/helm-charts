{
    ...
    "identity:get_credential": "rule:owner and user_id:%(target.credential.user_id)s",
    "identity:list_credentials": "rule:owner",
    "identity:create_credential": "rule:cloud_admin or user_id:%(credential.user_id)s",
    ...
    "identity:ec2_get_credential": "rule:owner and user_id:%(target.credential.user_id)s",
    "identity:ec2_list_credentials": "rule:owner",
