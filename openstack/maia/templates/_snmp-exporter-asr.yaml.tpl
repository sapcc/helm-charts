asrtest:
  ...
  - name: snmp_asr_ipNetToPhysicalPhysAddress
    ...
    - labelname: ipNetToPhysicalIfIndex
      type: gauge
    - labelname: ipNetToPhysicalNetAddressType
      type: gauge
  ...
  - name: snmp_asr_tcpConnectionState
    ...
    type: gauge
    indexes:
    - labelname: tcpConnectionLocalAddressType
      type: gauge
    - labelname: tcpConnectionLocalAddress
      type: OctetString
    - labelname: tcpConnectionLocalPort
      type: gauge
    - labelname: tcpConnectionRemAddressType
      type: gauge
    - labelname: tcpConnectionRemAddress
      type: OctetString
  ...
  - name: snmp_asr_tcpListenerProcess
    ...
    type: gauge
    indexes:
    - labelname: tcpListenerLocalAddressType
      type: gauge
    - labelname: tcpListenerLocalAddress
      type: OctetString
  ...
  - name: snmp_asr_udpEndpointProcess
    ...
    type: gauge
    indexes:
    - labelname: udpEndpointLocalAddressType
      type: gauge
    - labelname: udpEndpointLocalAddress
      type: OctetString
    - labelname: udpEndpointLocalPort
      type: gauge
    - labelname: udpEndpointRemoteAddressType
      type: gauge
    - labelname: udpEndpointRemoteAddress
      type: OctetString
    - labelname: udpEndpointRemotePort
      type: gauge
