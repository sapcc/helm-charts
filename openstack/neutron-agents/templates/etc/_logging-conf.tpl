{{/*
neutron-agents.logging-conf renders a Python logging.config ini body shared by
every neutron agent. Uses the loggerIni helper from the utils chart so consumers
can pass the same dict shape as the umbrella neutron chart's .Values.logging.
...
consumer side.
*/}}
{{- define "neutron-agents.logging-conf" -}}
{{- $default := dict
    "loggers" (dict
