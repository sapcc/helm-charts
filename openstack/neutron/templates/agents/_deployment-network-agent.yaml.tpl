    ...
    spec:
      ...
      containers:
        - name: neutron-dhcp-agent
          image: {{ default "hub.global.cloud.sap" $context.Values.global.imageRegistry }}/{{$context.Values.image_name}}:{{$context.Values.agent_image_tag | $context.Values.image_tag}}
