{
    ...
    "create_firewall": "rule:context_is_network_admin",
    "get_firewall": "rule:context_is_viewer",
    "create_firewall:shared": "rule:context_is_network_admin",
    "get_firewall:shared": "rule:context_is_viewer",
    "update_firewall": "rule:context_is_network_admin",
    "update_firewall:shared": "rule:context_is_network_admin",
    "delete_firewall": "rule:context_is_network_admin",
