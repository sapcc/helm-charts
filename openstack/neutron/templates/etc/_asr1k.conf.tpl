...
sync_chunk_size = {{.Values.asr.l3_sync_chunk_size | default 5}}
sync_interval = {{.Values.asr.l3_sync_interval | default 300}}
...
sync_chunk_size = {{.Values.asr.l2_sync_chunk_size | default 5}}
sync_interval = {{.Values.asr.l2_sync_interval | default 300}}
yang_connection_pool_size={{.Values.asr.netconf_yang_pool_size | default 5}}
