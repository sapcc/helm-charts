...
l3_admin_tenant = {{.Values.asr.l3_admin_tenant}}
...
image=
flavor=
default_credentials_id={{.Values.asr.hosting_device_template_1_credential}}
...
image=
flavor=
default_credentials_id={{.Values.asr.hosting_device_template_3_credential}}
configuration_mechanism=
protocol_port=22
booting_time=360
slot_capacity=2000
