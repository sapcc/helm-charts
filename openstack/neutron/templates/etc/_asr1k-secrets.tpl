...
password = {{$hosting_device.password | default $config_agent.password | required "A valid password must be supplied under config_agents or hosting_devices!" | include "resolve_secret" }}
{{end}}
