...
- name: cc3test-network-api.alerts
  ...
  - alert: OpenstackNeutronApiDown
    expr: |
        cc3test_status{service="neutron", type="api", phase="call"} == 0
    for: 16m
    labels:
      severity: critical
      ...
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-api"
  ...
  - alert: OpenstackNeutronApiFlapping
    expr: |
        changes(cc3test_status{service="neutron", type="api", phase="call"}[30m]) > 8
    labels:
      severity: warning
      support_group: network-api
      tier: os
  ...
  - alert: OpenstackNeutronLBApiDown
    ...
    labels:
      ...
      dashboard: "cc3test-api-status?var-service={{`{{ $labels.service }}`}}"
      persesDashboard: "https://perses.{{ .Values.global.region }}.{{ .Values.global.tld }}/projects/observability/dashboards/cc3test-api-status?var-service={{`{{ $labels.service }}`}}"
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-api/#openstackneutronlbapidown--openstackneutronlbapiflapping"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
...
- name: cc3test-network-datapath.alerts
  ...
  - alert: OpenstackNeutronDatapathPrivateIPDown
    ...
    labels:
      ...
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-api/#openstackneutrondatapathprivateipdown--openstackneutrondatapathprivateipflapping"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
  ...
  - alert: OpenstackNeutronDatapathPublicIPDown
    ...
    labels:
      ...
      dashboard: "cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      persesDashboard: "https://perses.{{ .Values.global.region }}.{{ .Values.global.tld }}/projects/observability/dashboards/cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-api/#openstackneutrondatapathpublicipdown--openstackneutrondatapathpublicipflapping"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
...
- name: cc3test-network-dhcp.alerts
  ...
  - alert: OpenstackNeutronDHCPDown
    ...
    labels:
      ...
      dashboard: "cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      persesDashboard: "https://perses.{{ .Values.global.region }}.{{ .Values.global.tld }}/projects/observability/dashboards/cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-dhcp-service"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
...
- name: cc3test-network-metadata.alerts
  ...
  - alert: OpenstackNeutronMetadataServiceDown
    ...
    labels:
      ...
      dashboard: "cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      persesDashboard: "https://perses.{{ .Values.global.region }}.{{ .Values.global.tld }}/projects/observability/dashboards/cc3test-datapath-status?var-service={{`{{ $labels.service }}`}}"
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-metadata-service"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
...
# TODO - we first will have to bring the integrity tests into one of the dashboards
#      dashboard: cc3test-api-status?var-service={{`{{ $labels.service }}`}}
      playbook: "docs/support/playbook/neutron/alerts/cc3test-alert-api/#openstackneutronintegrityoutoffips"
      report: "cc3test/admin/object-storage/swift/containers/cc3test/objects/{{`{{ $labels.base64path }}`}}"
    annotations:
