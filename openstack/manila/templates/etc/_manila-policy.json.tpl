{
  ...
  "share_server:index": "rule:context_is_viewer",
  "share_server:show": "rule:context_is_viewer",
  "share_server:details": "rule:context_is_viewer",
  ...
  "share_group:get": "rule:context_is_admin",
  ...
  "share_group_type:index": "rule:context_is_admin",
  "share_group_type:show": "rule:context_is_admin",
  "share_group_type:default": "rule:context_is_admin",
