...
maintenance_work_mem = {{ .Values.postgresql.maintenance_work_mem | 64MB }}		# min 1MB
...
#autovacuum_analyze_threshold = 50	# min number of row updates before
                    # analyze
autovacuum_vacuum_scale_factor = {{ .Values.postgresql.autovacuum_vacuum_scale_factor | default 0.2 }}	# fraction of table size before vacuum
autovacuum_analyze_scale_factor = {{ .Values.postgresql.autovacuum_analyze_scale_factor | default 0.1 }}	# fraction of table size before analyze
