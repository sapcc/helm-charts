...
SECRET_KEY='{{ .Values.horizon.secretKey }}'
{{- end }}
...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{include "memcached_host" .}}:{{ .Values.memcached.port }}',
    }
}
