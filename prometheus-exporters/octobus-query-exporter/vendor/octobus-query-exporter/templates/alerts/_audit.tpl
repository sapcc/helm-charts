      ...
      rules:
        - alert: OctobusAuditLogsSourceMissing
          ...
          labels:
            ...
            playbook: 'docs/operation/opensearch_issues/octobus/audit-source-missing/#audit-source-for-event-missing'
          annotations:
        ...
        - alert: OctobusAuditLogsDeadletter
          ...
          labels:
            ...
            dashboard: audit-log-shipping
            playbook: 'docs/operation/opensearch_issues/octobus/audit-source-missing/#audit-events-in-deadletter-index'
          annotations:
    ...
    {{- $name = camelcase $name }}
        - alert: OctobusAuditLogs{{ $name }}Missing
          ...
          labels:
            ...
            dashboard: audit-log-shipping
            playbook: 'docs/operation/opensearch_issues/octobus/audit-source-missing/#audit-events-missing'
          annotations:
