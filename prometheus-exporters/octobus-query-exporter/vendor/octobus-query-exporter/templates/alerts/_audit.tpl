      ...
      rules:
        - alert: OctobusAuditLogsSourceMissing
          ...
          labels:
            ...
            playbook: 'https://operations.global.cloud.sap/docs/support/playbook/opensearch/octobus/audit-source-missing/#audit-source-for-event-missing'
          annotations:
        ...
        - alert: OctobusAuditLogsDeadletter
          ...
          labels:
            ...
            dashboard: audit-log-shipping
            playbook: 'https://operations.global.cloud.sap/docs/support/playbook/opensearch/octobus/audit-source-missing/#audit-events-in-deadletter-index'
          annotations:
    ...
    {{- $name = camelcase $name }}
        - alert: OctobusAuditLogs{{ $name }}Missing
          ...
          labels:
            ...
            dashboard: audit-log-shipping
            playbook: 'https://operations.global.cloud.sap/docs/support/playbook/opensearch/octobus/audit-source-missing/#audit-events-missing'
          annotations:
