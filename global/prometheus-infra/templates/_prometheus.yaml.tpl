- job_name: 'prometheus-regions-federation'
  ...
  params:
    'match[]':
      ...
      - '{__name__=~"^vrops_vm_stats",statkey=~"vm_memory_kilobytes|number_vcpus_total"}'
      - '{__name__=~"^vrops_vm_properties", propkey=~"config_hardware_memory_kilobytes|summary_ethernetCards|runtime_connectionState: disconnected"}'
