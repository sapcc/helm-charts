- job_name: 'prometheus-regions-federation'
  ...
  params:
    'match[]':
      ...
      - '{__name__=~"^logstash_node_plugin_events_in_total"}'
      - '{__name__=~"^logstash_node_plugin_events_out_total"}'
      - '{__name__=~"^logstash_node_plugin_failures_total"}'
...
- job_name: 'prometheus-regions-vrops-federation'
  ...
  params:
    'match[]':
      ...
      - '{__name__=~"^vrops_inventory_target"}'
