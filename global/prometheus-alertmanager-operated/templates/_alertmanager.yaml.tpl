...
route:
  ...
  - receiver: slack_by_os_service
    ...
    match_re:
      tier: os
      severity: info|warning|critical
      service: arc|backup|barbican|castellum|cinder|cfm|designate|elektra|elk|glance|hermes|ironic|keppel|keystone|limes|lyra|maia|manila|neutron|nova|sentry|swift|octavia
