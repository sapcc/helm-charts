...
route:
  ...
  - receiver: pagerduty_ccloud_alertchain_test
    continue: false
    match_re:
      tier: test-tier
      region: area51
  ...
  - receiver: pagerduty_ccloud_ccloud_api
    continue: true
    match_re:
      tier: os|k8s|kks
      severity: critical
  ...
  - receiver: pagerduty_ccloud_sap_api
    continue: true
    match_re:
      tier: os|k8s|kks
      severity: critical
  ...
  - receiver: pagerduty_ccloud_ccloud_metal
    continue: true
    match_re:
      tier: metal
      severity: critical
  ...
  - receiver: pagerduty_ccloud_sap_metal
    continue: true
    match_re:
      tier: metal
      severity: critical
  ...
  - receiver: pagerduty_ccloud_ccloud_vmware
    continue: true
    match_re:
      tier: vmware
      severity: critical
  ...
  - receiver: pagerduty_ccloud_sap_vmware
    continue: true
    match_re:
      tier: vmware
      severity: critical
  ...
  - receiver: pagerduty_ccloud_ccloud_network
    continue: true
    match_re:
      tier: net
      severity: critical
 ...
 - receiver: pagerduty_ccloud_sap_network
    continue: true
    match_re:
      tier: net
      severity: critical
  ...
  - receiver: slack_net_ccloud_critical
    continue: false
    match_re:
      tier: net
      severity: critical
